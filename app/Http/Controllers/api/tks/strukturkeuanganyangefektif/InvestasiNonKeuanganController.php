...
class InvestasiNonKeuanganController extends Controller
{
    function data(Request $request)
    {
        try {
            ...
            $nRatio = PerhitunganTKS::getRatioE4($nSaldoA, $nSaldoB);

            $vaArray = [
                ['Sandi' => 'A', 'Keterangan' => 'Total Investasi Non-Keuangan', 'Nilai' => Func::formatSaldo($nSaldoA), 'Status' => 'I'],
                ...
                ['Sandi' => 'SASARAN', 'Keterangan' => '0%', 'Nilai' => Func::formatSaldo($nRatio) . '%', 'Status' => 'I'],
            ];
            ...
            if ($vaData) {
                ...
                Func::writeLog('Investasi Non Keuangan', 'data', $vaRequestData, $vaRetVal, $cUser);
