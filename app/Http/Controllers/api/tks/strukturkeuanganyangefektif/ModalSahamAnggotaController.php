...
class ModalSahamAnggotaController extends Controller
{
    function data(Request $request)
    {
        try {
            ...
            $nRatio = PerhitunganTKS::getRatioE7($nSaldoA, $nSaldoB);

            $vaArray = [
                ['Sandi' => 'A', 'Keterangan' => 'Total Simpanan Saham Anggota', 'Nilai' => Func::formatSaldo($nSaldoA), 'Status' => 'I'],
            ...
            if ($vaData) {
                ...
                Func::writeLog('Modal Saham Anggota', 'data', $vaRequestData, $vaRetVal, $cUser);
