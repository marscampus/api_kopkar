...
class SimpananNonSahamController extends Controller
{
    function data(Request $request)
    {
        try {
            ...
            $nRatio = PerhitunganTKS::getRatioE5($nSaldoA, $nSaldoB);

            $vaArray = [
                ['Sandi' => 'A', 'Keterangan' => 'Total Simpanan Non Saham', 'Nilai' => Func::formatSaldo($nSaldoA), 'Status' => 'I'],
            ...
            if ($vaData) {
                ...
                Func::writeLog('Simpanan Non Saham', 'data', $vaRequestData, $vaRetVal, $cUser);
