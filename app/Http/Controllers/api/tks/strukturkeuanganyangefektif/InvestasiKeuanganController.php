...
class InvestasiKeuanganController extends Controller
{
    function data(Request $request)
    {
        try {
            ...
            $nRatio = PerhitunganTKS::getRatioE3($nSaldoA, $nSaldoB);

            $vaArray = [
                ['Sandi' => 'A', 'Keterangan' => 'Total Investasi Keuangan', 'Nilai' => Func::formatSaldo($nSaldoA), 'Status' => 'I'],
            ...
            if ($vaData) {
                ...
                Func::writeLog('Investasi Keuangan', 'data', $vaRequestData, $vaRetVal, $cUser);
