...
class InvestasiLikuidController extends Controller
{
    function data(Request $request)
    {
        try {
            ...
            $vaArray = [
                ['Sandi' => 'A', 'Keterangan' => 'Total Investasi Likuid', 'Nilai' => Func::formatSaldo($nSaldoA), 'Status' => 'I'],
                ...
                ['Sandi' => 'SASARAN', 'Keterangan' => 'Maksimal 20%', 'Nilai' => Func::formatSaldo($nRatio) . '%', 'Status' => 'I'],
            ];
            ...
            if ($vaData) {
                ...
                Func::writeLog('Investasi Likuid', 'data', $vaRequestData, $vaRetVal, $cUser);
