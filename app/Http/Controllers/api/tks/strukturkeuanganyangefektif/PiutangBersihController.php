...
class PiutangBersihController extends Controller
{
    function data(Request $request)
    {
        try {
            ...
            $nRatio = 0;
            if ($nSaldoC != 0) {
                $nRatio = (($nSaldoA - $nSaldoB) / $nSaldoC) * 100;
            }

            $vaArray = [
                ['Sandi' => 'A', 'Keterangan' => 'Total Pinjaman Beredar', 'Nilai' => Func::formatSaldo($nSaldoA), 'Status' => 'I'],
                ['Sandi' => 'B', 'Keterangan' => 'Dana Cadangan Resiko', 'Nilai' => Func::formatSaldo($nSaldoB), 'Status' => 'I'],
                ...
                ['Sandi' => 'SASARAN', 'Keterangan' => 'Antara 70% - 80%', 'Nilai' => Func::formatSaldo($nRatio) . '%', 'Status' => 'I'],
            ];
            ...
            if ($vaData) {
                ...
                Func::writeLog('Piutang Bersih', 'data', $vaRequestData, $vaRetVal, $cUser);
