...
class TotalBiayaOperasionalController extends Controller
{
    function data(Request $request)
    {
        try {
            ...
            $nRatio = PerhitunganTKS::getRatioR9($nSaldoA, $nSaldoB, $nSaldoC);

            $vaArray = [
                ['Sandi' => 'A', 'Keterangan' => 'Total Biaya Operasional (Diluar Provisi untuk Pinjaman Lalai)', 'Nilai' => Func::formatSaldo($nSaldoA), 'Status' => 'I'],
            ...
            if ($vaData) {
                ...
                Func::writeLog('Total Biaya Operasional', 'data', $vaRequestData, $vaRetVal, $cUser);
