...
class LabaBersihController extends Controller
{
    function data(Request $request)
    {
        try {
            ...
            $nRatio = PerhitunganTKS::getRatioR12($nSaldoA, $nSaldoB, $nSaldoC);

            $vaArray = [
                ['Sandi' => 'A', 'Keterangan' => 'Laba Bersih (Setelah Deviden)', 'Nilai' => Func::formatSaldo($nSaldoA), 'Status' => 'I'],
                ...
                ['Sandi' => 'SASARAN', 'Keterangan' => 'Mampu Memenuhi Sasaran Ideal E9', 'Nilai' => Func::formatSaldo($nRatio) . '%', 'Status' => 'I'],
            ];
            ...
            if ($vaData) {
                ...
                Func::writeLog('Laba Bersih', 'data', $vaRequestData, $vaRetVal, $cUser);
