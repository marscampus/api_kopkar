...
class PertumbuhanAsetController extends Controller
{
    function data(Request $request)
    {
        try {
            ...
            $nRatio = PerhitunganTKS::getRatioE2($nSaldoA, $nSaldoB);

            $vaArray = [
                ['Sandi' => 'A', 'Keterangan' => 'Total Aset Tahun Berjalan', 'Nilai' => Func::formatSaldo($nSaldoA), 'Status' => 'I'],
                ['Sandi' => 'B', 'Keterangan' => 'Total Aset Sampai Akhir Tahun Lalu', 'Nilai' => Func::formatSaldo($nSaldoB), 'Status' => 'I'],
                ['Sandi' => 'RUMUS', 'Keterangan' => '[(A / B)-1] x 100 atau [(A - B) / B] x 100', 'Nilai' => '', 'Status' => 'I'],
                ['Sandi' => '', 'Keterangan' => '', 'Nilai' => 'RATIO', 'Status' => 'ID'],
                ['Sandi' => 'SASARAN', 'Keterangan' => 'Di Atas Tingkat Inflasi', 'Nilai' => Func::formatSaldo($nRatio) . '%', 'Status' => 'I'],
            ];
            ...
            if ($vaData) {
                ...
                Func::writeLog('Pertumbuhan Aset', 'data', $vaRequestData, $vaRetVal, $cUser);
