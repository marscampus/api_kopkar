...
namespace App\Http\Controllers\api\tks\kualitasaset;
...
class TotalAsetYangTidakMenghasilkanController extends Controller
{
    function data(Request $request)
    {
        try {
            ...
            $nRatio = PerhitunganTKS::getRatioA2($nSaldoA, $nSaldoB);

            $vaArray = [
                ['Sandi' => 'A', 'Keterangan' => 'Total Total Aset Yang Tidak Menghasilkan', 'Nilai' => Func::formatSaldo($nSaldoA), 'Status' => 'I'],
                ...
                ['Sandi' => 'SASARAN', 'Keterangan' => '<= 5%', 'Nilai' => Func::formatSaldo($nRatio) . '%', 'Status' => 'I'],
            ];
            ...
            if ($vaData) {
                ...
                Func::writeLog('Total Aset Yang Tidak Menghasilkan', 'data', $vaRequestData, $vaRetVal, $cUser);
