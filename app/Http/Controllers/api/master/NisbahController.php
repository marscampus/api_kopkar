 ...
 *
 * Created on Tue Jan 16 2024 - 03:11:02
    ...
    public function store(Request $request)
    {
        try {
            ...
            if ($nReqCount > 4 || $nReqCount < 4) {
                ...
                Func::writeLog('Nisbah', 'store', $vaRequestData, $vaRetVal, $cUser);
                // return $vaRetval;
                return response()->json(['status' => 'error']);
            }
            ...
            $vaArray = [
                ...
                'Nisbah' => $vaRequestData['Nisbah']
            ];
            Nisbah::create($vaArray);
            // JIKA REQUEST SUKSES
            $vaRetVal = [
                "status" => "00",
                "message" => "SUKSES"
    ...
    function update(Request $request)
    {
        try {
            ...
            if ($nReqCount > 4 || $nReqCount < 4) {
                ...
                Func::writeLog('Nisbah', 'update', $vaRequestData, $vaRetVal, $cUser);
                // return $vaRetval;
                return response()->json(['status' => 'error']);
            }
            ...
            if ($vaData) {
                ...
                Nisbah::where('Kode', '=', $cKode)->update($vaArray);
                // JIKA REQUEST SUKSES
                $vaRetVal = [
                    "status" => "00",
                    "message" => "SUKSES"
    ...
    function delete(Request $request)
    {
        try {
            ...
            if ($nReqCount > 1 || $nReqCount < 1 || $vaRequestData['Kode'] == null || empty($vaRequestData['Kode'])) {
                ...
                Func::writeLog('Nisbah', 'delete', $vaRequestData, $vaRetVal, $cUser);
                // return $vaRetVal;
                return response()->json(['status' => 'error']);
            }
            $vaData = Nisbah::findOrFail($vaRequestData['Kode']);
            $vaData->delete();
            $vaRetVal = [
                "status" => "00",
                "message" => "SUKSES"
