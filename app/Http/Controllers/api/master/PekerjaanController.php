 ...
 *
 * Created on Fri Dec 22 2023 - 20:17:10
    ...
    function data(Request $request)
    {
        try {
            ...
            if ($vaData) {
                ...
                Func::writeLog('Pekerjaan', 'data', $vaRequestData, $vaRetVal, $cUser);
    ...
    function store(Request $request)
    {
        try {
            ...
            if ($nReqCount > 2 || $nReqCount < 2) {
                ...
                Func::writeLog('Pekerjaan', 'store', $vaRequestData, $vaRetVal, $cUser);
                // return $vaRetval;
                return response()->json(['status' => 'error']);
            }
            ...
            if ($vaValidator->fails()) {
                ...
                Func::writeLog('Pekerjaan', 'update', $vaRequestData, $vaRetVal, $cUser);
                // return response()->json($vaRetVal);
                return response()->json([
                    'status' => 'error',
                    'message' => $vaErrorMsgs
    ...
    function update(Request $request)
    {
        try {
            ...
            if ($vaData) {
                ...
                Pekerjaan::where('Kode', '=', $cKode)->update($vaArray);
                // JIKA REQUEST SUKSES
                $vaRetVal = [
                    "status" => "00",
                    "message" => "SUKSES"
    ...
    function delete(Request $request)
    {
        try {
            ...
            if ($nReqCount > 1 || $nReqCount < 1 || $vaRequestData['Kode'] == null || empty($vaRequestData['Kode'])) {
                ...
                Func::writeLog('Pekerjaan', 'delete', $vaRequestData, $vaRetVal, $cUser);
                // return $vaRetVal;
                return response()->json(['status' => 'error']);
            }
            $vaData = Pekerjaan::findOrFail($vaRequestData['Kode']);
            $vaData->delete();
            $vaRetVal = [
                "status" => "00",
                "message" => "SUKSES"
