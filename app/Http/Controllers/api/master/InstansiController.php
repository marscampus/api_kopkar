 ...
 *
 * Created on Thu Mar 21 2024 - 08:36:37
...
class InstansiController extends Controller
{
    ...
    function data(Request $request)
    {
        ...
        try {
            ...
            if ($vaData) {
                ...
                Func::writeLog('Instansi', 'data', $vaRequestData, $vaRetVal, $cUser);
    ...
    function update(Request $request, $Kode)
    {
        ...
        //     'KETERANGAN'=>'required'
        // ]);
        $Instansi = Instansi::where('Kode', $Kode)->update([
            'Keterangan' => $request->Keterangan
        ]);
        return response()->json(['status' => 'success']);
    }
    ...
    function delete(Request $request)
    {
        ...
        try {
            $Instansi = Instansi::findOrFail($request->Kode);
            $Instansi->delete();
            return response()->json(['status' => 'success']);
        } catch (\Throwable $th) {
            return response()->json(['status' => 'error']);
