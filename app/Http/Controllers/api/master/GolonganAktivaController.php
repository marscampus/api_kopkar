 ...
 *
 * Created on Sun Jan 21 2024 - 12:06:27
...
use App\Models\master\GolonganAktiva;
    ...
    public function data(Request $request)
    {
        try {
            ...
            if ($vaData) {
                ...
                Func::writeLog('Golongan Aktiva', 'data', $vaRequestData, $vaRetVal, $cUser);
    ...
    public function store(Request $request)
    {
        try {
            ...
            if ($nReqCount < 4) {
                ...
                Func::writeLog('Golongan Aktiva', 'store', $vaRequestData, $vaRetVal, $cUser);
                // return $vaRetval;
                return response()->json(['status' => 'error']);
            }
            ...
            if ($vaValidator->fails()) {
                $vaErrorMsg = $vaValidator->errors()->first();
                $vaRetval = [
                    "status" => "99",
                    "message" => $vaErrorMsg
                ];
            ...
            $vaArray = [
                ...
                'RekeningDebet' => $vaRequestData['RekeningDebet'],
                'RekeningKredit' => $vaRequestData['RekeningKredit']
            ];
            GolonganAktiva::create($vaArray);
            // JIKA REQUEST SUKSES
            $vaRetVal = [
                "status" => "00",
                "message" => "SUKSES"
    ...
    function update(Request $request)
    {
        try {
            ...
            if ($nReqCount < 4) {
                ...
                Func::writeLog('Golongan Aktiva', 'update', $vaRequestData, $vaRetVal, $cUser);
                // return $vaRetval;
                return response()->json(['status' => 'error']);
            }
            ...
            if ($vaData) {
                ...
                GolonganAktiva::where('Kode', '=', $vaRequestData['Kode'])->update($vaArray);
                // JIKA REQUEST SUKSES
                $vaRetVal = [
                    "status" => "00",
                    "message" => "SUKSES"
    ...
    function delete(Request $request)
    {
        try {
            ...
            if ($nReqCount > 1 || $nReqCount < 1 || $vaRequestData['Kode'] == null || empty($vaRequestData['Kode'])) {
                ...
                Func::writeLog('Golongan Aktiva', 'delete', $vaRequestData, $vaRetVal, $cUser);
                // return $vaRetVal;
                return response()->json(['status' => 'error']);
            }
            $vaData = GolonganAktiva::findOrFail($vaRequestData['Kode']);
            $vaData->delete();
            $vaRetVal = [
                "status" => "00",
                "message" => "SUKSES"
