 ...
 *
 * Created on Fri Dec 22 2023 - 20:12:35
    ...
    function data(Request $request)
    {
        try {
            ...
            if ($vaData) {
                ...
                Func::writeLog('Agama', 'data', $vaRequestData, $vaRetVal, $cUser);
    ...
    function store(Request $request)
    {
        try {
            ...
            if ($nReqCount > 2 || $nReqCount < 2) {
                ...
                Func::writeLog('Agama', 'store', $vaRequestData, $vaRetVal, $cUser);
                // return $vaRetval;
                return response()->json(['status' => 'error']);
            }
            ...
            if ($vaValidator->fails()) {
                ...
                Func::writeLog('Agama', 'update', $vaRequestData, $vaRetVal, $cUser);
                // return response()->json($vaRetVal);
    ...
    function update(Request $request)
    {
        try {
            ...
            if ($vaData) {
                ...
                Agama::where('Kode', '=', $cKode)->update($vaArray);
                // JIKA REQUEST SUKSES
                $vaRetVal = [
                    "status" => "00",
                    "message" => "SUKSES"
    ...
    function delete(Request $request)
    {
        try {
            ...
            if ($nReqCount > 1 || $nReqCount < 1 || $vaRequestData['Kode'] == null || empty($vaRequestData['Kode'])) {
                ...
                Func::writeLog('Agama', 'delete', $vaRequestData, $vaRetVal, $cUser);
                // return $vaRetVal;
                return response()->json(['status' => 'error']);
            }
            $vaData = Agama::findOrFail($vaRequestData['Kode']);
            $vaData->delete();
            $vaRetVal = [
                "status" => "00",
                "message" => "SUKSES"
